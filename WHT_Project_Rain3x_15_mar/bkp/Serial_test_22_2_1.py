...
##        except:
    ...
    def cmd_03(self): ##-------Version And model
        global serial_data
        length=len(serial_data)
        ...
        cable_number=cable_number_name[0:seperation_len]#model seperation
        
        cable_name=cable_number_name[seperation_len+1:length]#version seperation
        print(cable_number)
        print(cable_name)
